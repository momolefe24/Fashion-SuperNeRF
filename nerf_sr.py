...
from NeRF_SR.cat_model import SuperNeRF, Discriminator, initialize_weights, ContentLoss
from torch.optim.lr_scheduler import CosineAnnealingLR, MultiStepLR
import torch.optim as optim
from torch import nn
from torch.utils.tensorboard import SummaryWriter

generator = SuperNeRF(in_channels=3, num_channels=64, num_blocks=23, num_layers=8).to(device)
